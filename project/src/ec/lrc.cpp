...
bool LocallyRepairableCode::generate_flow_repair_plan(std::vector<int> failure_idxs,
...
bool Opt_Cau_LRC::generate_flow_repair_plan(std::vector<int> failure_idxs,
															std::vector<RepairPlan>& plans,
															bool partial_scheme,
															bool repair_priority,
															bool repair_method,
